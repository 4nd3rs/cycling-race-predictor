    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl py-8">
        ...
        <div className="flex items-center gap-4 mb-8">
          {user.avatarUrl ? (
            <img src={user.avatarUrl} alt={user.name || "Avatar"} className="w-14 h-14 rounded-full border border-border/50" />
          ) : (
          ...
          <Badge variant="outline" className="capitalize ml-auto">{user.tier}</Badge>
        </div>
