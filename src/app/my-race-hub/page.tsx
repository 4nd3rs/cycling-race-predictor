        ...
        <div className="flex items-start gap-4 mb-8">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 mt-2 flex-wrap">
              <Link href="?tab=notifications" className={"inline-flex items-center gap-1.5 text-xs px-2 py-0.5 rounded-full border transition-colors " + (data.whatsapp?.phoneNumber ? "bg-green-500/15 border-green-500/30 text-green-400 hover:bg-green-500/25" : "bg-muted/30 border-border/40 text-muted-foreground hover:bg-muted/50")}>
                <span className={"w-1.5 h-1.5 rounded-full " + (data.whatsapp?.phoneNumber ? "bg-green-400" : "bg-muted-foreground/40")}></span>
                {data.whatsapp?.phoneNumber ? "WhatsApp connected" : "Join WhatsApp group"}
              </Link>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4 max-w-2xl">
            {feedItems.length === 0 ? (
              <div className="rounded-xl border border-border/50 bg-card/20 p-8 text-center">
                <p className="text-muted-foreground text-sm">No messages yet. Join the WhatsApp group and follow some riders to get started.</p>
              </div>
            ) : (
