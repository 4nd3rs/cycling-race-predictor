        ...
        <div className="flex items-start gap-4 mb-8">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 mt-2 flex-wrap">
              {data.telegram?.connectedAt ? (
                <Link href="?tab=notifications" className="inline-flex items-center gap-1.5 text-xs px-2 py-0.5 rounded-full bg-blue-500/15 border border-blue-500/30 text-blue-400 hover:bg-blue-500/25 transition-colors">
                  <span className="w-1.5 h-1.5 rounded-full bg-blue-400"></span>
                  Telegram connected
                </Link>
              ) : (
                <Link href="?tab=notifications" className="inline-flex items-center gap-1.5 text-xs px-2 py-0.5 rounded-full bg-muted/30 border border-border/40 text-muted-foreground hover:bg-muted/50 transition-colors">
                  <span className="w-1.5 h-1.5 rounded-full bg-muted-foreground/50"></span>
                  Connect Telegram
                </Link>
              )}
              <a href="https://www.instagram.com/procyclingpredictor" target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 text-xs px-2 py-0.5 rounded-full bg-pink-500/15 border border-pink-500/30 text-pink-400 hover:bg-pink-500/25 transition-colors">
